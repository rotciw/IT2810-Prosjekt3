...
Videre har gruppen laget unit-tester for MobX stores. Disse tester at actions og observables fungerer som de skal. Det er også brukt Enzyme for integrasjonstesting, der vi tester Pagination komponenten. Eksempel:
